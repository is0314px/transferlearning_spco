...
df_melt = pd.melt(df)
sns.violinplot(x='variable',y='value', data=df_melt, jitter=False, palette=sns.color_palette("OrRd", 7), ax=ax)
...
#plt.show()
plt.savefig("gibbs_result/"+result+"/Position_prediction_result/adaption/pos_cost_local_violin.png",dpi=1000)
