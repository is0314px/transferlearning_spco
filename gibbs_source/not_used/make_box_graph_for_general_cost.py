...
df_melt = pd.melt(df)
sns.boxplot(x='variable',y='value', data=df_melt, palette=colors, ax=ax,
...
#plt.show()
plt.savefig("gibbs_result/"+result+"/Position_prediction_result/generalization/pos_cost_general_box.png",dpi=1000)
#"""