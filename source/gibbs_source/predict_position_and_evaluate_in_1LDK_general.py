...
dir = "../gibbs_dataset/sigverse/1LDK_9" 
...
while per <= MAX_PER:
    ...
    label_idx = [0,1,7,2,6,5,4,3] #index of name label
    ...
    for i, name in enumerate(Names):
        ...
        for pos in sample_pos:
            ...
            if name == "entrance":
                ...
                if (-140 <= x and x <= 140) and (-290 <= y and y <= -90):
                ...
                if (140 <= x and x <= 240) and (-290 <= y and y <= -90):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((-550 <= x and x <= -500) and (-290 <= y and y <= 200)) or ((-500 <= x and x <= -140) and (-290 <= y and y <= 300)) or ((-140 <= x and x <= -60) and (0 <= y and y <= 300)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((210 <= x and x <= 450) and (-500 <= y and y <= -290)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((-60 <= x and x <= 220) and (60 <= y and y <= 550)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((290 <= x and x <= 550) and (240 <= y and y <= 550)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((290 <= x and x <= 550) and (-90 <= y and y <= 240)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((240 <= x and x <= 550) and (-290 <= y and y <= -90)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
