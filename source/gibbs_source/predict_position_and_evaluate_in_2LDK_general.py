...
dir = "../gibbs_dataset/sigverse/2LDK_9" 
...
while per <= MAX_PER:
    ...
    label_idx = [0,6,[1,5],7,3,4,2,8] #index of name label
    ...
    for i, name in enumerate(Names):
        ...
        for pos in sample_pos:
            ...
            if name == "entrance":
                ...
                if (-300 <= x and x <= -130) and (-180 <= y and y <= -10):
                ...
                if (-90 <= x and x <= 0) and (-540 <= y and y <= -340):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((-450 <= x and x <= -140) and (-10 <= y and y <= 550)) or (((100 <= x and x <= 450) and (-540 <= y and y <= -35)) or ((0 <= x and x <= 100) and (-540 <= y and y <= -340))):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((-330 <= x and x <= -90) and (-540 <= y and y <= -340)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((100 <= x and x <= 450) and (250 <= y and y <= 550)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((180 <= x and x <= 450) and (-35 <= y and y <= 200)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((-140 <= x and x <= 100) and (170 <= y and y <= 550)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
                ...
                if ((-300 <= x and x <= -90) and (-340 <= y and y <= -180)):
                    cnt_vector[name_dic.tolist().index(name)] += 1
