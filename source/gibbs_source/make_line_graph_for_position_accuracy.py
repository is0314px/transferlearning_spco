...
#dic_dim = 18
place_num = 10
cl = np.array([1.0/place_num for i in range(len(x))])
print(cl)
y = []
e = []
...
plt.savefig("gibbs_result/"+result+"/Position_prediction_result/adaption/position_acc_specific.png",dpi=1000)
