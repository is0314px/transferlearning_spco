...
cl = np.array([(1.0/8.0) for i in range(len(x))])
...
for model in models:
    ...
    fn = "pos_acc_general"
    f = "gibbs_result/sigverse_result/"+model+"/Position_evaluation/"+fn+".txt"
...
plt.savefig("gibbs_result/"+result+"/Position_prediction_result/generalization/position_acc_general.png",dpi=1000)